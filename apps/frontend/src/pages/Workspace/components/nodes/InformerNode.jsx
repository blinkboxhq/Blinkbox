...
export default function InformerNode({ config = {}, updateConfig }) {
  ...
  return (
    <div className="flex flex-col gap-5 w-full">
      ...
      {/* Header */}
      <div className="flex items-center gap-3 p-4 bg-purple-500/5 border border-neutral-800 rounded-xl">
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className={`w-full bg-surface-1 border rounded-lg px-3 py-2.5 text-xs font-mono focus:outline-none transition-all placeholder-neutral-700 ${
            isValidUrl
              ? 'border-purple-500/30 text-purple-200 focus:border-purple-500/50'
              : 'border-neutral-800 text-neutral-300 focus:border-purple-500/30'
          }`}
        />
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          <textarea
            ...
            rows={4}
            className="w-full bg-surface-1 border border-neutral-800 rounded-lg p-3 text-xs text-white focus:outline-none focus:border-purple-500/30 transition-colors resize-none leading-relaxed placeholder-neutral-600"
          />
          <div className="absolute bottom-2.5 right-3 text-[9px] text-neutral-700 font-mono pointer-events-none uppercase">
            Plain English
          </div>
        </div>
      </div>
