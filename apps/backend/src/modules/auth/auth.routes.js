...
import { register, login, loginTwoFactor, googleLogin, forgotPassword, resetPassword, verifyEmail, resendVerification, changeOwnerPassword } from "./auth.controller.js";
import { verifyPasswordChangeToken } from "./auth.middleware.js";
...
router.post("/owner/password", makeRateLimiter({ key: 'bb:rl:ownerpw', max: 10, windowSecs: 900, message: 'Too many attempts. Try again later.' }), verifyPasswordChangeToken, changeOwnerPassword);
