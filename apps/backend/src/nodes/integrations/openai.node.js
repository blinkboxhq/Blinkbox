...
async function opMessage(config, input, apiKey) {
  ...
  if (!prompt) throw new Error("OpenAI message: 'prompt' is required.");
...
async function opAnalyzeImage(config, input, apiKey) {
  ...
  if (!url) throw new Error("OpenAI analyzeImage: 'imageUrl' is required.");
...
async function opGenerateImage(config, input, apiKey) {
  ...
  if (!description) throw new Error("OpenAI generateImage: 'imagePrompt' is required.");
...
async function opTranscribeAudio(config, input, apiKey) {
  ...
  if (!url) throw new Error("OpenAI transcribeAudio: 'audioUrl' is required.");
...
async function opModerateContent(config, input, apiKey) {
  ...
  if (!text) throw new Error("OpenAI moderateContent: text to moderate is required.");
...
async function opGeneratePrompt(config, input, apiKey) {
  ...
  if (!taskDescription) throw new Error("OpenAI generatePrompt: 'task' description is required.");
...
async function opImprovePrompt(config, input, apiKey) {
  ...
  if (!originalPrompt) throw new Error("OpenAI improvePrompt: 'prompt' to improve is required.");
