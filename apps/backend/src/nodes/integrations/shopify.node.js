...
async function getToken(credentialId, workspaceId) {
  const cred = await resolveCredential(credentialId, workspaceId, "Shopify");
...
export default {
  async run(config, input, context = {}) {
    ...
    if (!shop) throw new Error("Shopify: 'shop' (e.g. mystore.myshopify.com) is required.");
    ...
    try {
      switch (operation) {
        ...
        case "getProduct": {
          if (!config.productId) throw new Error("Shopify getProduct: 'productId' is required.");
        ...
        case "createProduct": {
          if (!config.title) throw new Error("Shopify createProduct: 'title' is required.");
        ...
        case "updateProduct": {
          if (!config.productId) throw new Error("Shopify updateProduct: 'productId' is required.");
          const product = {};
        ...
        case "getOrder": {
          if (!config.orderId) throw new Error("Shopify getOrder: 'orderId' is required.");
        ...
        case "updateOrder": {
          if (!config.orderId) throw new Error("Shopify updateOrder: 'orderId' is required.");
          const order = {};
        ...
        case "createCustomer": {
          if (!config.email) throw new Error("Shopify createCustomer: 'email' is required.");
        ...
        case "getCustomer": {
          ...
          if (!config.customerId) throw new Error("Shopify getCustomer: 'customerId' or 'email' is required.");
