          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none bg-[#111] border border-[#333] rounded-lg px-3 py-2 pr-8 text-[12px] text-zinc-100 focus:outline-none focus:border-zinc-600 cursor-pointer"
              >
                {models.map((m) => {
