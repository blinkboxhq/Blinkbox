...
async function opListSites(config, { headers: h }) {
  const { data } = await axios.get(`${GRAPH}/sites?search=*`, { headers: h, timeout: 120000 });
...
async function opGetSite(config, { headers: h, siteId }) {
  ...
  const { data } = await axios.get(`${GRAPH}/sites/${encodeURIComponent(siteId)}`, { headers: h, timeout: 120000 });
...
async function opListDrives(config, { headers: h, siteId }) {
  ...
  const { data } = await axios.get(`${GRAPH}/sites/${encodeURIComponent(siteId)}/drives`, { headers: h, timeout: 120000 });
...
async function opListLists(config, { headers: h, siteId }) {
  ...
  const { data } = await axios.get(`${GRAPH}/sites/${encodeURIComponent(siteId)}/lists`, { headers: h, timeout: 120000 });
...
async function opGetListItems(config, { headers: h, siteId, input }) {
  ...
  const { data } = await axios.get(`${GRAPH}/sites/${encodeURIComponent(siteId)}/lists/${encodeURIComponent(listId)}/items?expand=fields`, { headers: h, timeout: 120000 });
...
async function opCreateListItem(config, { headers: h, siteId, input }) {
  ...
  const { data } = await axios.post(`${GRAPH}/sites/${encodeURIComponent(siteId)}/lists/${encodeURIComponent(listId)}/items`, { fields }, { headers: h, timeout: 120000 });
