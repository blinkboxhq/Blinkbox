...
import modelCatalogRoutes from "../modules/modelCatalog/modelCatalog.routes.js";
import integrationActionRoutes from "../modules/actions/integrationActions.routes.js";
...
import selfHostRoutes from "../modules/selfhost/selfhost.routes.js";
...
app.use("/api/models", modelCatalogRoutes);
app.use("/api/integrations", integrationActionRoutes);
app.use("/api/oauth", oauthRoutes);
app.use("/api/billing", billingRoutes);
app.use("/api/feedback", feedbackRoutes);
app.use("/api/chat", chatRoutes);
app.use("/api/keys", apiKeyRoutes);
app.use("/api/self-host", selfHostRoutes);
app.use("/api/mcp", mcpRoutes);
app.use("/api/mcp-client", mcpClientRoutes);
