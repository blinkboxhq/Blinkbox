...
export const NodeRegistry = {
  ...
  clinical_trials: {
    ...
    colorClass: "text-red-400",
    accentColor: "248,113,113",
    ConfigPanel: ClinicalTrialsNode,
    category: "research",
  ...
  currency_exchange: {
    ...
    colorClass: "text-yellow-400",
    accentColor: "250,204,21",
    ConfigPanel: CurrencyExchangeNode,
    category: "research",
  ...
  producthunt: {
    ...
    ConfigPanel: ProductHuntNode,
    category: "social_pub",
    description:
      "Fetch product launches, upvotes and comments from Product Hunt",
  },
  hackernews: {
    label: "Hacker News",
    icon: Rss,
    colorClass: "text-[#FF6600]",
    accentColor: "255,102,0",
    logoUrl: imgHackerNews,
    ConfigPanel: HackerNewsNode,
    category: "research",
  ...
  cron: {
    ...
    category: "flow",
    description:
      "Run on a schedule — every minute, hour, day or custom cron expression",
  },
  chat: {
    label: "Chat Trigger",
    icon: MessageSquarePlus,
  ...
  twitch_stream_status: {
    ...
    accentColor: "145,70,255",
    ConfigPanel: TwitchStreamStatusNode,
    category: "gaming",
    description: "Check live status, stream info, top clips and schedule",
  },
  discord_role_assign: {
    label: "Discord Role Assign",
    icon: Users,
    colorClass: "text-[#5865F2]",
    accentColor: "88,101,242",
    logoUrl: imgDiscord,
    ConfigPanel: DiscordRoleAssignNode,
    category: "gaming",
  ...
  schedule_check: {
    ...
    colorClass: "text-amber-400",
    accentColor: "251,191,36",
    ConfigPanel: ScheduleCheckNode,
    category: "automation",
    description:
      "Is it currently within business hours? With holiday exclusions",
  },
  ip_whitelist: {
  ...
  markdown_renderer: {
    ...
    colorClass: "text-white",
    accentColor: "129,140,248",
    ConfigPanel: MarkdownRendererNode,
    category: "transform",
  ...
  color_converter: {
    ...
    colorClass: "text-white",
    accentColor: "232,121,249",
    ConfigPanel: ColorConverterNode,
    category: "transform",
