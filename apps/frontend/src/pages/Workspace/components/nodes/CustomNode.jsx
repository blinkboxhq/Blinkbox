  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center"
        style={{
          opacity: 0.5, width: cardW, height: cardH, borderRadius: 6,
          background: GLASS_BG,
    ...
    return (
      <div className="relative group" style={{ width: cardW, height: cardH + 28 }}>
        ...
        <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.25, ease: [0.23, 1, 0.32, 1] }}
          ...
          style={{ width: cardW, height: cardH, borderRadius: 10,
            background: GLASS_BG,
            backdropFilter: "blur(12px) saturate(120%)", WebkitBackdropFilter: "blur(12px) saturate(120%)",
          ...
          <div className="absolute inset-0 pointer-events-none" style={{ borderRadius: 9, background: "linear-gradient(180deg, rgba(255,255,255,0.03) 0%, transparent 40%)" }} />
