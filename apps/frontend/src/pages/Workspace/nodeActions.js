...
export const NODE_ACTIONS = {
  ...
  zendesk: [
    { name: "List Tickets", description: "List recent support tickets" },
    { name: "Get Ticket", description: "Fetch a ticket by its ID" },
    { name: "Create Ticket", description: "Open a new support ticket" },
    { name: "Update Ticket", description: "Modify status, priority, or fields" },
    ...
    { name: "Close Ticket", description: "Set a ticket to closed/solved" },
    { name: "List Comments", description: "List a ticket's comments" },
    { name: "Add Ticket Tags", description: "Add tags to a ticket" },
    { name: "Remove Ticket Tags", description: "Remove tags from a ticket" },
    { name: "Count Tickets", description: "Count total tickets" },
    { name: "List Ticket Audits", description: "List a ticket's audit trail" },
    { name: "Mark As Spam", description: "Mark a ticket as spam and suspend requester" },
    { name: "Merge Tickets", description: "Merge source tickets into a target" },
    { name: "Search Tickets", description: "Search tickets using Zendesk Query Language" },
    { name: "List Users", description: "List agents and end-users" },
    { name: "Get User", description: "Fetch a user by ID" },
    { name: "Create User", description: "Create a new user" },
    { name: "Update User", description: "Modify an existing user" },
    { name: "Delete User", description: "Delete a user" },
    { name: "Create Or Update User", description: "Upsert a user by email" },
    { name: "Search Users", description: "Search users by query" },
    { name: "List User Tickets", description: "List tickets requested/assigned to a user" },
    { name: "Add User Tags", description: "Add tags to a user" },
    { name: "List Organizations", description: "List organizations" },
    { name: "Get Organization", description: "Fetch an organization by ID" },
    { name: "Create Organization", description: "Create an organization" },
    { name: "Update Organization", description: "Modify an organization" },
    { name: "Delete Organization", description: "Delete an organization" },
    { name: "Search Organizations", description: "Search organizations by name" },
    { name: "List Organization Tickets", description: "List an org's tickets" },
    { name: "List Groups", description: "List agent groups" },
    { name: "Get Group", description: "Fetch a group by ID" },
    { name: "Create Group", description: "Create an agent group" },
    { name: "Update Group", description: "Modify a group" },
    { name: "Delete Group", description: "Delete a group" },
    { name: "List Ticket Fields", description: "List all ticket fields" },
    { name: "Create Ticket Field", description: "Create a custom ticket field" },
    { name: "List Macros", description: "List macros" },
    { name: "Apply Macro", description: "Apply a macro to a ticket" },
    { name: "List Views", description: "List ticket views" },
    { name: "Execute View", description: "List tickets in a view" },
    { name: "Count View", description: "Count tickets in a view" },
    { name: "Unified Search", description: "Search across tickets, users, and orgs" },
    { name: "List Satisfaction Ratings", description: "List CSAT ratings" },
    { name: "List Articles", description: "List Help Center articles" },
    { name: "Get Article", description: "Fetch a Help Center article" },
    { name: "Create Article", description: "Publish a Help Center article" },
    { name: "Update Article", description: "Edit a Help Center article" },
    { name: "Delete Article", description: "Delete a Help Center article" },
    { name: "List Sections", description: "List Help Center sections" },
    { name: "Create Section", description: "Create a Help Center section" },
    { name: "List Categories", description: "List Help Center categories" },
    { name: "Create Category", description: "Create a Help Center category" },
  ],
  calendly: [
    { name: "Get User", description: "Fetch a user or the authenticated account" },
    { name: "Get Current Organization", description: "Resolve the current organization URI" },
    { name: "List Organization Memberships", description: "List members of an organization" },
    { name: "Get Organization Membership", description: "Fetch a single membership by URI" },
    { name: "Remove Organization Membership", description: "Remove a member from the organization" },
    { name: "List Organization Invitations", description: "List pending and past invitations" },
    { name: "Invite User", description: "Invite a teammate to the organization" },
    { name: "Revoke Invitation", description: "Revoke a pending organization invitation" },
    { name: "List Event Types", description: "List all booking types" },
    { name: "Get Event Type", description: "Fetch a single event type by URI" },
    { name: "Get Available Times", description: "Available slots for an event type in a window" },
    { name: "Create Single-use Link", description: "Generate a one-time booking link" },
    { name: "List Events", description: "Fetch scheduled meetings with filters" },
    { name: "Get Event", description: "Fetch details of a scheduled event" },
    { name: "Cancel Event", description: "Cancel a scheduled Calendly event" },
    { name: "List Invitees", description: "List invitees on a scheduled event" },
    { name: "Get Invitee", description: "Fetch details about a single invitee" },
    { name: "Mark No-Show", description: "Flag an invitee as a no-show" },
    { name: "Undo No-Show", description: "Remove a no-show flag from an invitee" },
    { name: "List Availability Schedules", description: "List a user's availability schedules" },
    { name: "Get Availability Schedule", description: "Fetch a single availability schedule" },
    { name: "Get Busy Times", description: "Fetch a user's busy times in a window" },
    { name: "List Webhooks", description: "List webhook subscriptions" },
    { name: "Get Webhook", description: "Fetch a webhook subscription by URI" },
    { name: "Create Webhook", description: "Subscribe to Calendly events via https" },
    { name: "Delete Webhook", description: "Delete a webhook subscription" },
    { name: "List Routing Forms", description: "List routing forms in the organization" },
    { name: "Get Routing Form", description: "Fetch a single routing form" },
    { name: "List Form Submissions", description: "List submissions for a routing form" },
    { name: "List Groups", description: "List enterprise groups in the organization" },
    { name: "Get Group", description: "Fetch a single enterprise group" },
    { name: "Delete Invitee Data", description: "GDPR deletion request for invitee emails" },
  ],
  mailchimp: [
  ...
  intercom: [
    { name: "Create Contact", description: "Create a new contact in Intercom" },
    { name: "Update Contact", description: "Update an existing Intercom contact" },
    { name: "Get Contact", description: "Fetch a contact by id or email" },
    { name: "Send Message", description: "Send a message to a contact" },
    { name: "New Conversation", description: "Start a new conversation with a contact" },
    { name: "Reply to Conversation", description: "Reply to an existing conversation" },
    { name: "Add Tag", description: "Tag a contact or conversation" },
    { name: "Track Event", description: "Log a custom event for a contact" },
  ],
  linkedin: [
    { name: "Share Post", description: "Publish a post to your LinkedIn feed" },
    { name: "Get My Profile", description: "Fetch your LinkedIn profile" },
    { name: "Get Company", description: "Fetch a company page by id" },
    { name: "Get Connections", description: "List your LinkedIn connections" },
  ],
  onedrive: [
    { name: "Upload File", description: "Upload a file to OneDrive" },
    { name: "Download File", description: "Download a file from OneDrive" },
    { name: "List Files", description: "List files in a OneDrive folder" },
    { name: "Delete File", description: "Delete a file from OneDrive" },
    { name: "Create Folder", description: "Create a new folder" },
    { name: "Move / Rename", description: "Move or rename a file" },
    { name: "Create Share Link", description: "Generate a shareable link for a file" },
    { name: "Get File Info", description: "Fetch metadata for a file" },
  ],
  outlook: [
    { name: "Send Email", description: "Send an email via Outlook" },
    { name: "Reply to Email", description: "Reply to an existing email" },
    { name: "Get Email", description: "Fetch a single email by id" },
    { name: "List Emails", description: "List emails from a folder" },
    { name: "Create Calendar Event", description: "Add an event to your calendar" },
    { name: "List Calendar Events", description: "List events from your calendar" },
    { name: "Create Contact", description: "Add a new contact" },
    { name: "Move to Folder", description: "Move an email to another folder" },
    { name: "Flag / Unflag", description: "Flag or unflag an email" },
  ],
  sharepoint: [
    { name: "List Sites", description: "List SharePoint sites" },
    { name: "List Files", description: "List files in a document library" },
    ...
    { name: "Search Files", description: "Search files across a site" },
  ],
  teams: [
    { name: "Send Message", description: "Post a message to a Teams channel" },
    { name: "Send Adaptive Card", description: "Post an adaptive card to a channel" },
    { name: "Reply to Thread", description: "Reply to a message thread" },
    { name: "Create Channel", description: "Create a new channel in a team" },
    { name: "List Channels", description: "List channels in a team" },
    { name: "List Teams", description: "List teams you belong to" },
    { name: "Create Meeting", description: "Schedule a Teams meeting" },
  ],
  typeform: [
    { name: "List Forms", description: "List your Typeform forms" },
    { name: "Get Form", description: "Fetch a form's definition" },
    { name: "List Responses", description: "List responses to a form" },
    { name: "Get Response", description: "Fetch a single response" },
    { name: "Create Form", description: "Create a new Typeform" },
    { name: "Delete Response", description: "Delete a form response" },
  ],
  woocommerce: [
    { name: "Get Order", description: "Fetch an order by id" },
    { name: "List Orders", description: "List store orders" },
    { name: "Update Order Status", description: "Change an order's status" },
    { name: "Create Product", description: "Add a new product" },
    { name: "Update Product", description: "Update an existing product" },
    { name: "Get Product", description: "Fetch a product by id" },
    { name: "List Products", description: "List store products" },
    { name: "Get Customer", description: "Fetch a customer by id" },
    { name: "Create Coupon", description: "Create a discount coupon" },
  ],
  zoom: [
    { name: "Create Meeting", description: "Schedule a new Zoom meeting" },
    { name: "Get Meeting", description: "Fetch a meeting by id" },
