...
function assertSafeUrl(rawUrl) {
  ...
  const blocked = /^(localhost|127\.|10\.|172\.(1[6-9]|2\d|3[01])\.|192\.168\.|169\.254\.|::1|fd|fc)/i;
  if (blocked.test(u.hostname)) throw new Error(`SSRF blocked: "${u.hostname}" is a private/internal address.`);
}
