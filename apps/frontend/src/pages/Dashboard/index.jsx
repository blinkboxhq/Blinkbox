...
export default function Dashboard() {
  ...
  if (!user) return <div className="h-screen w-screen bg-neutral-900 flex items-center justify-center"><Loader2 className="w-5 h-5 text-neutral-700 animate-spin" /></div>;
