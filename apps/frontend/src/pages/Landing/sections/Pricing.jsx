...
const TIERS = [
  {
    ...
    features: ['1,000 credits / month', 'Unlimited workflows', 'All 251 integrations', 'Community support'],
    cta: 'Start free',
    featured: false,
  },
  {
    ...
    features: ['30,000 credits / month', 'Buy extra credits any time', 'Brian AI copilot', 'Retries, delays & branching', 'Priority support'],
    cta: 'Go Pro',
    featured: true,
  },
  {
    ...
    features: ['Same rate at every pack size', 'Packs from $10 to $100', 'Credits never expire', 'Works on any plan'],
    cta: 'Buy credits',
    featured: false,
  },
];
