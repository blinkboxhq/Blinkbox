      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-[6px] bg-zinc-900 border border-zinc-800/80 rounded-md text-[12px] text-white placeholder:text-neutral-700 focus:outline-none focus:border-neutral-700 transition-colors"
          />
        </div>
