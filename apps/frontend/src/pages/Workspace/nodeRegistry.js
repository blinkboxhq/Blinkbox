...
export const NodeRegistry = {
  ...
  agent_openai: {
    ...
    ConfigPanel: makeAgentModelPanel({
      ...
      models: ["gpt-4o", "gpt-4o-mini", "gpt-4-turbo", "o1-preview", "o3-mini"],
      color: "#10A37F",
    }),
  },
  agent_anthropic: {
  ...
  agent_integration_slack:          { label: "Slack",           icon: Zap, logoUrl: imgSlack,          colorClass: "text-[#E01E5A]", accentColor: "224,30,90",   category: "ai", agentOnly: true, description: "Post messages, files & DMs", ConfigPanel: GenericActionNode },
  agent_integration_gmail:          { label: "Gmail",           icon: Mail, logoUrl: imgGmail,         colorClass: "text-[#EA4335]", accentColor: "234,67,53",   category: "ai", agentOnly: true, description: "Send & search email",       ConfigPanel: GenericActionNode },
  agent_integration_discord:        { label: "Discord",         icon: Zap, logoUrl: imgDiscord,        colorClass: "text-[#5865F2]", accentColor: "88,101,242",  category: "ai", agentOnly: true, description: "Post to channels",          ConfigPanel: GenericActionNode },
  agent_integration_telegram:       { label: "Telegram",        icon: Zap, logoUrl: imgTelegram,       colorClass: "text-[#229ED9]", accentColor: "34,158,217",  category: "ai", agentOnly: true, description: "Send messages via bot",     ConfigPanel: GenericActionNode },
  agent_integration_notion:         { label: "Notion",          icon: FileText, logoUrl: imgNotion,    colorClass: "text-zinc-300",  accentColor: "161,161,170", category: "ai", agentOnly: true, description: "Create & query pages",      ConfigPanel: GenericActionNode, imgFilter: "invert(1)" },
  agent_integration_airtable:       { label: "Airtable",        icon: Database, logoUrl: imgAirtable,  colorClass: "text-[#F82B60]", accentColor: "248,43,96",   category: "ai", agentOnly: true, description: "Create & read records",     ConfigPanel: GenericActionNode },
  agent_integration_google_sheets:  { label: "Google Sheets",   icon: FileText, logoUrl: imgGoogleSheets, colorClass: "text-[#34A853]", accentColor: "52,168,83", category: "ai", agentOnly: true, description: "Read & append rows",      ConfigPanel: GenericActionNode },
  agent_integration_google_calendar:{ label: "Google Calendar", icon: Zap, logoUrl: imgGoogleCalendar, colorClass: "text-[#4285F4]", accentColor: "66,133,244",  category: "ai", agentOnly: true, description: "Create & manage events",   ConfigPanel: GenericActionNode },
  agent_integration_google_drive:   { label: "Google Drive",    icon: Zap, logoUrl: imgGoogleDrive,    colorClass: "text-[#FBBC05]", accentColor: "251,188,5",   category: "ai", agentOnly: true, description: "Upload, list & share files",ConfigPanel: GenericActionNode },
  agent_integration_outlook:        { label: "Outlook",         icon: Mail, logoUrl: imgOutlook,       colorClass: "text-[#0078D4]", accentColor: "0,120,212",   category: "ai", agentOnly: true, description: "Email via Microsoft",       ConfigPanel: GenericActionNode },
  agent_integration_github:         { label: "GitHub",          icon: GitBranch, logoUrl: imgGitHub,   colorClass: "text-zinc-300",  accentColor: "161,161,170", category: "ai", agentOnly: true, description: "Issues, PRs, comments",     ConfigPanel: GenericActionNode, imgFilter: "invert(1)" },
  agent_integration_linear:         { label: "Linear",          icon: Zap, logoUrl: imgLinear,         colorClass: "text-[#5E6AD2]", accentColor: "94,106,210",  category: "ai", agentOnly: true, description: "Create & update issues",    ConfigPanel: GenericActionNode },
  agent_integration_hubspot:        { label: "HubSpot",         icon: Zap, logoUrl: imgHubSpot,        colorClass: "text-[#FF7A59]", accentColor: "255,122,89",  category: "ai", agentOnly: true, description: "CRM contacts & deals",      ConfigPanel: GenericActionNode },
  agent_integration_jira:           { label: "Jira",            icon: Zap, logoUrl: imgJira,           colorClass: "text-[#0052CC]", accentColor: "0,82,204",    category: "ai", agentOnly: true, description: "Tickets, sprints & projects",ConfigPanel: GenericActionNode },
  agent_integration_asana:          { label: "Asana",           icon: Zap, logoUrl: imgAsana,          colorClass: "text-[#F06A6A]", accentColor: "240,106,106", category: "ai", agentOnly: true, description: "Tasks & project tracking",  ConfigPanel: GenericActionNode },
  agent_integration_stripe:         { label: "Stripe",          icon: Zap, logoUrl: imgStripe,         colorClass: "text-[#635BFF]", accentColor: "99,91,255",   category: "ai", agentOnly: true, description: "Payments & subscriptions",  ConfigPanel: GenericActionNode },
  agent_integration_shopify:        { label: "Shopify",         icon: Zap, logoUrl: imgShopify,        colorClass: "text-[#95BF47]", accentColor: "149,191,71",  category: "ai", agentOnly: true, description: "Orders, products, customers",ConfigPanel: GenericActionNode },
  agent_integration_clickup:        { label: "ClickUp",         icon: Zap, logoUrl: imgClickUp,        colorClass: "text-[#7B68EE]", accentColor: "123,104,238", category: "ai", agentOnly: true, description: "Tasks & workspace mgmt",    ConfigPanel: GenericActionNode },
  agent_integration_twilio:         { label: "Twilio",          icon: Zap, logoUrl: imgTwilio,         colorClass: "text-[#F22F46]", accentColor: "242,47,70",   category: "ai", agentOnly: true, description: "SMS & voice messaging",     ConfigPanel: GenericActionNode },
  agent_integration_mongodb:        { label: "MongoDB",         icon: Database, logoUrl: imgMongoDB,   colorClass: "text-[#4DB33D]", accentColor: "77,179,61",   category: "ai", agentOnly: true, description: "Query & insert documents",  ConfigPanel: GenericActionNode },
  agent_integration_postgres:       { label: "PostgreSQL",      icon: Database, logoUrl: imgPostgres,  colorClass: "text-[#336791]", accentColor: "51,103,145",  category: "ai", agentOnly: true, description: "Run SQL queries",           ConfigPanel: GenericActionNode },
  agent_integration_redis:          { label: "Redis",           icon: Database, logoUrl: imgRedis,     colorClass: "text-[#DC382D]", accentColor: "220,56,45",   category: "ai", agentOnly: true, description: "Get & set cache values",    ConfigPanel: GenericActionNode },
  ...
  github_issue: {
    ...
    category: "devtools",
    description:
      "Create, update, comment on or close GitHub issues and pull requests",
  },
  gitlab: {
    label: "GitLab",
    icon: Github,
