/**
 * MiniMax — shared primitives. BASE url, default model constants, known-model
...
export const BASE = "https://api.minimax.io/v1";

export const DEFAULT_CHAT_MODEL   = "MiniMax-M3";
export const DEFAULT_VISION_MODEL = "MiniMax-M3";
export const DEFAULT_THINK_MODEL  = "MiniMax-M3";
