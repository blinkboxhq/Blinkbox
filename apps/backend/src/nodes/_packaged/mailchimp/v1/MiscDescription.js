...
async function opCreateMergeField(config, client) {
  ...
  const data = await req(client, "post", `/lists/${encodeURIComponent(listId)}/merge-fields`, { body, timeout: 10000 });
...
async function opUpdateMergeField(config, client) {
  ...
  const data = await req(client, "patch", `/lists/${encodeURIComponent(listId)}/merge-fields/${encodeURIComponent(mergeId)}`, { body, timeout: 10000 });
...
async function opDeleteMergeField(config, client) {
  ...
  await req(client, "delete", `/lists/${encodeURIComponent(listId)}/merge-fields/${encodeURIComponent(mergeId)}`, { timeout: 10000 });
...
async function opListSegments(config, client) {
  ...
  const data = await req(client, "get", `/lists/${encodeURIComponent(listId)}/segments`, { params, timeout: 10000 });
...
async function opGetSegment(config, client) {
  ...
  return req(client, "get", `/lists/${encodeURIComponent(listId)}/segments/${encodeURIComponent(segmentId)}`, { timeout: 10000 });
}
...
async function opCreateSegment(config, client) {
  ...
  const data = await req(client, "post", `/lists/${encodeURIComponent(listId)}/segments`, { body, timeout: 10000 });
...
async function opUpdateSegment(config, client) {
  ...
  const body = {};
  if (config.name) body.name = config.name;
  const data = await req(client, "patch", `/lists/${encodeURIComponent(listId)}/segments/${encodeURIComponent(segmentId)}`, { body, timeout: 10000 });
...
async function opDeleteSegment(config, client) {
  ...
  await req(client, "delete", `/lists/${encodeURIComponent(listId)}/segments/${encodeURIComponent(segmentId)}`, { timeout: 10000 });
...
async function opRemoveSegmentMember(config, client) {
  ...
  await req(client, "delete", `/lists/${encodeURIComponent(listId)}/segments/${encodeURIComponent(segmentId)}/members/${emailHash(email)}`, { timeout: 10000 });
...
async function opListTemplates(config, client) {
  ...
  const data = await req(client, "get", "/templates", { params, timeout: 10000 });
...
async function opGetTemplate(config, client) {
  ...
  return req(client, "get", `/templates/${encodeURIComponent(id)}`, { timeout: 10000 });
}
...
async function opDeleteTemplate(config, client) {
  ...
  await req(client, "delete", `/templates/${encodeURIComponent(id)}`, { timeout: 10000 });
...
async function opGetReport(config, client) {
  ...
  return req(client, "get", `/reports/${encodeURIComponent(id)}`, { timeout: 15000 });
}
...
async function opGetAutomation(config, client) {
  ...
  return req(client, "get", `/automations/${encodeURIComponent(id)}`, { timeout: 10000 });
}
...
async function opStartAutomation(config, client) {
  ...
  await req(client, "post", `/automations/${encodeURIComponent(id)}/actions/start-all-emails`, { body: {}, timeout: 10000 });
...
async function opPauseAutomation(config, client) {
  ...
  await req(client, "post", `/automations/${encodeURIComponent(id)}/actions/pause-all-emails`, { body: {}, timeout: 10000 });
...
async function opPing(config, client) {
  const data = await req(client, "get", "/ping", { timeout: 10000 });
