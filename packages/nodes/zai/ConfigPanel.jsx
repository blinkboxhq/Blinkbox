...
function ChatPanel({ config, updateConfig, nodeId }) {
  return (
    <>
      <Dropdown label="Model" value={config.model} fallback="glm-5.2" onChange={(v) => updateConfig('model', v)} options={opt(MODELS_CHAT)} />
...
function CodePanel({ config, updateConfig, nodeId }) {
  return (
    <>
      <Dropdown label="Model" value={config.model} fallback="glm-5.2" onChange={(v) => updateConfig('model', v)} options={opt(MODELS_CODE)} />
...
function ReasoningPanel({ config, updateConfig, nodeId }) {
  return (
    <>
      <Dropdown label="Model" value={config.model} fallback="glm-5.2" onChange={(v) => updateConfig('model', v)} options={opt(MODELS_REASON)} />
...
function VisionPanel({ config, updateConfig, nodeId }) {
  return (
    <>
      <Dropdown label="Model" value={config.model} fallback="glm-4.6v" onChange={(v) => updateConfig('model', v)} options={opt(MODELS_VISION)} />
